...
public class RegisterActivity extends AppCompatActivity {
   ...
   // truyền dữ liệu qua trang đk thứ 2 bằng bundle
    ...
    private boolean validateFullName(){
        ...
        if(val.isEmpty()){
            TXTL_signup_HoVaTen.setError(getResources().getString(R.string.not_empty));
            return false;
        }else {
    ...
    private boolean validateUserName(){
        ...
        if(val.isEmpty()){
            TXTL_signup_TenDN.setError(getResources().getString(R.string.not_empty));
            return false;
    ...
    private boolean validatePhone(){
        ...
        if(val.isEmpty()){
            TXTL_signup_SDT.setError(getResources().getString(R.string.not_empty));
            return false;
